...
\newd[Structural Induction]{d3}{
    ...
    \newm{
        ...
        prove $p(x)$ for all base cases of the definition of $S$, $p(x)$ for the constructor cases of the definition of $S$.
        ...
        \indenv{
            ...
            \indenv{
                ...
                Consider $f=(f'\star f'')$ where $\star\in\{\aand ,\oor \}$, then $\N_v(f)=\N_v(f')+\N_v(f'')=(1+\N_c(f'))+(1+\N_c(f''))=1+(\N_c(f')+\N_c(f'')+1)=1+\N_c(f)$
            }
        }
    }
    \newr{
