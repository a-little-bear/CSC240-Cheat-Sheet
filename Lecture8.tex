...
\newm{
    ...
    \newr{$2\times3+1$ is ambiguous. When a recursive definition allows an element to be constructed in more than one way, the definition is \underline{ambiguous}}
}
...
\newd[Structural Induction]{d3}{
    ...
    \newr{
        ...
        So weak induction can be viewed as stuctural induction.
    }
}
